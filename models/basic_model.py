...
class Net(nn.Module):
  def __init__(self, input_size=256, out_channel=3, mode='nearest', freeze=True):
    ...
    if freeze:
        ...
        for parameter in self.midlevel_resnet.parameters():
    ...
    self.upsample = nn.Sequential(     
      ...
      nn.BatchNorm2d(32),
      nn.ReLU(),
      nn.Conv2d(32, out_channel, kernel_size=3, stride=1, padding=1),
      nn.Upsample(scale_factor=2, mode=mode)
    )
